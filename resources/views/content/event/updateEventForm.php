      ...
      <div class="modal-body">
        <form action="../../../controllers/form_handler.php?action=update-event&eventId=<?= $event['id'] ?>" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input name="titulo" type="text" class="form-control" id="inputEmail4" value="<?=$event['titulo']?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input name="descricao" type="text" class="form-control" id="inputPassword4" value="<?=$event['descricao']?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input name="desc_promocao" type="text" class="form-control" id="inputAddress2" value="<?=$event['desc_promocao']?>">
            </div>
            <div class="mb-3">
                <label for="inputAddress2" class="form-label">Hora do Evento</label>
                <input name="horario" type="time" class="form-control" id="inputAddress2" value="<?=$event['horario']?>">
            </div>
            <div class="mb-3">
                <label for="inputAddress2" class="form-label">Data</label>
                <input name="data" type="date" class="form-control" id="inputAddress2" value="<?=$event['data']?>">
            </div>
            <div class="mb-3">
                <label for="inputZip" class="form-label">CEP</label>
                <input name="cep" type="text" class="form-control" id="inputZip" onblur="pesquisacep(this.value);" value="<?=$event['cep']?>">
            </div>
            <div class="mb-3">
                <label for="inputCity" class="form-label">Cidade</label>
                <input name="cidade" type="text" class="form-control" id="cidade" readonly value="<?=$event['cidade']?>">
            </div>
            <div class="mb-3">
                <label for="inputState" class="form-label">Estado</label>
                <input name="uf" type="text" class="form-control" id="uf" readonly value="<?=$event['uf']?>">
            </div>
            <div class="mb-3">
                <label for="inputAddress2" class="form-label">Rua</label>
                <input name="rua" type="text" class="form-control" id="rua" readonly value="<?=$event['rua']?>">
            </div>
            <div class="mb-3">
                <label for="inputAddress2" class="form-label">Número</label>
                <input name="numero" type="text" class="form-control" id="inputAddress2" value="<?=$event['numero']?>">
            </div>
            <div class="mb-3">
                <label for="inputAddress2" class="form-label">Bairro</label>
                <input name="bairro" type="text" class="form-control" id="bairro" readonly value="<?=$event['bairro']?>">
            </div>
