        ...
        <nav class="navbar">
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu me-5">
                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#userForm"><h2 class="fs-6">Editar Perfil</h2></a></li>
                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#eventForm"><h2 class="fs-6">Promover Evento</h2></a></li>
