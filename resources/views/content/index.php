...
<html lang="pt-br">
  ...
  <body class="d-flex flex-column">
      ...
      ?>
          ...
          <div class="w-25 px-4 mt-5 mb-2 card-wrapper"> 
          ...
          <?php
              if ($event['user_id'] === $user['id']) {
                  ...
                  <div class="edit-buttons-container d-flex justify-content-end ms-3">
                      <div class="d-flex">
                          <button data-bs-toggle="modal" data-bs-target="#update_modal_<?=$event['id']?>" title="Editar Evento" class="btn-wrap btn btn-warning pt-2 text-light d-flex align-items-center justify-content-center fs-6 pt-3 edit-form-btn ">
                              <ion-icon name="create-outline"></ion-icon>
                          </button>
                      </div>
                      <div class="d-flex">
                        <button data-bs-toggle="modal" data-bs-target="#inactivate_<?=$event['id']?>"  title="Excluir Evento" type="button" class="btn btn-primary btn-wrap btn btn-danger pt-2 text-light d-flex align-items-center justify-content-center fs-6 pt-3 edit-form-btn">
    ...
    <footer class="footer justify-self-end mt-5 d-flex pt-1 fixed-footer">
        <div class="d-flex flex-column justify-content-center align-items-center w-100 gap-3">
            <a href="../terms/privacy.php" class="text-decoration-none fw-bolder text-body-tertiary footer-link" target="_blank">Política de Privacidade</a>
            <a href="../terms/conditions.php" class="text-decoration-none fw-bolder text-body-tertiary footer-link" target="_blank">Condições de Uso</a>
        </div>
    </footer>
