...
if (!$_SESSION['id']) {
  ...
  if($conn) {
    ...
    $events = $oEvent->getMyEvents($user['id']);
  }
  ...
  <body class="d-flex flex-column">
      ...
      <header>
        ...
        <nav class="navbar">
            <div class="navbar-logo-container">
              <a href="./myEvents.php" class="hvr-opacity">
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><a class="dropdown-item" href="./index.php"><h2 class="fs-6">Tela Principal</h2></a></li>
      ...
      <main class="main-content" >
        ...
        ?>
          ...
          <div class="card-wrapper <?= $isActiveStyle ?>"> 
            <div class="card hvr-float" data-bs-toggle="modal" data-bs-target="#modal_<?=$event['id']?>">
              <?php
                if ($event['user_id'] === $user['id'] && $event['flag_ativo'] === "N") {
                  echo "<h1 class='fs-6 text-center text-danger'>Evento Inativo</h1>";
                }
              ?>
              ...
              <div class="card-footer-btn">
                ...
                <div class="d-flex">
                  <form id="inactiveEvent" action="../../../controllers/form_handler.php?action=active-event&userId=<?= $user['id']?>&eventId=<?= $event['id'] ?>" method="post">
                      <button title="Reativar Evento" class="btn edit-form-btn hvr-opacity">
